...
MODEL                   = servo
MODULES                 = rt_nonfinite.c servo.c servo_capi.c servo_data.c servo_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = servo.exe
MAKEFILE                = servo.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2024b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2024b
START_DIR               = C:\Users\ALIEMI~1\SERVO_~1
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 4
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = servo_ref.rsp
COMPILER_COMMAND_FILE     = servo_comp.rsp
